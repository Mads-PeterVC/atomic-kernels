...
use super::super::shortcuts::spawn_hints_section;
use super::{section_body_bundle, section_title_bundle};
use crate::ui::{PANEL_BACKGROUND, PANEL_BORDER, SECTION_BACKGROUND};

pub(super) fn spawn_inspector_panel(
