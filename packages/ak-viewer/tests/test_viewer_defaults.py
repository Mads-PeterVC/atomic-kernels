...
def test_bevy_viewer_enables_ui_by_default(monkeypatch):
    ...
    monkeypatch.setattr(
        "ak_viewer.viewer.trajectory_viewer",
...
def test_viewer_session_enables_ui_by_default(monkeypatch):
    ...
    monkeypatch.setattr("ak_viewer.viewer._viewer_session_requires_process", lambda: False)
    monkeypatch.setattr(
        "ak_viewer.viewer._launch_viewer",
...
def test_render_config_accepts_atom_palette_argument():
    from ak_viewer.viewer import RenderConfig
